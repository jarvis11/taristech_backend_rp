...
class AdvertisersControllerTest < ActionController::TestCase
  ...
  test "should create advertiser" do
    assert_difference('Advertiser.count') do
      post :create, advertiser: { address: @advertiser.address, name: @advertiser.name, verification: @advertiser.verification }
    end
  ...
  test "should update advertiser" do
    patch :update, id: @advertiser, advertiser: { address: @advertiser.address, name: @advertiser.name, verification: @advertiser.verification }
    assert_redirected_to advertiser_path(assigns(:advertiser))
  end
